...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-white flex flex-col justify-center px-8 py-16 md:flex-row md:gap-16 md:px-20">
      {/* Left Section */}
      <div className="md:w-1/2 text-[15px] leading-relaxed">
        <h2 className="text-2xl md:text-3xl font-medium text-black leading-[1.1] max-w-[500px] mb-6">
          If you have any questions or you'd like to find out more about our
          services, please get in touch.
        </h2>

        <div className="space-y-4">
          <p className="font-semibold text-black text-[14px]">Contact details:</p>

          <div>
            <p className="text-[14px] text-black/60 font-semibold mb-1">Office address:</p>
          ...
          <div>
            <p className="text-[14px] text-black/60 font-medium mb-1">Registered address:</p>
            <p className="text-[14px] text-black/50 leading-relaxed">
              Unit 4 <br />
          ...
          <div className="pt-2 space-y-1">
            <p className="text-[14px] text-[#9b9b9b]">
              <span className="font-medium text-[#9b9b9b]">Tel:</span>{" "}
              020 3345 3310
            </p>
            <p className="text-[14px] text-[#9b9b9b]">
